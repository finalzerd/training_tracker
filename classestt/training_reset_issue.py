...
class ResetCourse:
    def reset_course_new(self, link:str, us_id:str)-> bool:
...
# def main():
#     obj=ResetCourse()
#     obj.reset_course_new("https://www.udemy.com/course/deeplearning/learn/lecture/6743222#overview","engage@fischerjordan.com")
