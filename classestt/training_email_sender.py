...
from .fj_email_simple import FJEmailSimple
import pandas as pd
# from html import HTML

class TrainingEmailSender:
    def __init__(self) -> None:
        self.admin_emails: List[str] = ["darshana.shetty@fischerjordan.com","anoushka.khanna@fischerjordan.com"]
        #self.admin_emails: List[str] = ["yash.jain@fischerjordan.com"]
        self.main_admin_email = self.admin_emails[0]
        self.code_admin_emails: List[str] = ["ayushman.agrawal@fischerjordan.com","yash.jain@fischerjordan.com"]
        
    def send_course_start_email(self, course: Course) -> None:
        ...
        start_date_str: str = "today" if datetime.today().date() == course.start_date.date() else course.start_date.strftime("%m/%d/%y")
        ...
        email_text = f"""Hi {taker.first_name()},<br><br>
                         ...
                         If you have any questions, Please fell free to contact {self.main_admin_email}.<br><br>   
                         Thanks,<br><br>
                         FJ Training"""
        ...
        email = FJEmailSimple(to=[taker.email],
                              ...
                              bcc=self.code_admin_emails,
                              subject=title,
                              title=title,
                              text=email_text)
        email.send()
        
    def send_course_start_email_rescheduled(self, course: Course) -> None:
        """To be sent to the taker a day before the course starts."""
        taker: CourseTaker = course.taker
        word_course: str = "course" if len(course.links) == 1 else "courses"
    ...
    def send_training_reminder_email(self, course: Course) -> None:
        taker: CourseTaker = course.taker
        days_remaining: int = (course.end_date.date() - datetime.today().date()).days
        word_course: str = "course" if len(course.links) == 1 else "courses"
        ...
        email_text = f"""Hi {taker.first_name()},<br><br>
                        ...
                        Please make sure to complete the {word_course} by this deadline or reach out to {self.main_admin_email} if you need more time.<br><br>
                        Thanks,<br><br>
                        FJ Training"""
    ...
    def send_unfinished_by_deadline_email(self, course: Course) -> None:
        ...
        email_text = f"""Hi {taker.first_name()},<br><br>
                        ...
                        Please contact {self.main_admin_email} to schedule an extension.<br><br>
                        Thanks,<br><br>
                        FJ Training"""
        email = FJEmailSimple(to=[taker.email],
                              cc=self.admin_emails,
    ...
    def send_reschedule_reminder_email(self, course: Course) -> None:
        """
    ...
    def send_completion_email(self, course: Course) -> None:
    ...
    def send_completion_email_with_quiz(self, course: Course, quiz_url:str) -> None:
        """Asking for feedback on the course after they complete as a survey link
        as well as a quiz link to complete"""
        if quiz_url == "":
            self.send_completion_email(course)
            return
        taker = course.taker
        title = "FJ Training Course - Action Required"
        word_course = "course" if len(course.links) == 1 else "courses"
    ...
    def send_feedback_request_email(self, course: Course) -> None:
    ...
    def send_error_email(self, course: Course, error: Exception) -> None:
        course.box_completion = -1
        email = FJEmailSimple(to=self.code_admin_emails,
                              subject="Training Tracker Error",
                              text=f"Error->{str(error)}<br><br>{course}")
        email.send()
    
    def only_quiz_email(self,course: Course) -> None:
        """ Asking for feedback on the subsequent weeks after. """
        taker = course.taker
        title = "FJ Training Course - Action Required"
        word_course = "course" if len(course.links) == 1 else "courses"
    ...
    def send_quiz_request_email(self, course: Course) -> None:
        """ Asking for feedback on the subsequent weeks after. """
        taker = course.taker
        title = "FJ Training Course - Action Required"
        word_course = "course" if len(course.links) == 1 else "courses"
    ...
    def send_failed_quiz_email(self, course: Course) -> None:
        ...
        email_text = f"""Hi {taker.first_name()},<br><br>
                        ...
                        Please contact {self.main_admin_email} to reschedule the {word_course}, else it will be recorded as incomplete.<br><br>
                        Thanks,<br><br>
                        FJ Training"""
        email = FJEmailSimple(to=[taker.email],
                              cc=self.admin_emails,
    ...
    def send_failed_quiz_twice_email(self, course: Course) -> None:
    ...
    def send_completion_after_quiz_email(self, course: Course) -> None:
        """Asking for feedback on the course after they complete as a survey link"""
        taker = course.taker
    ...
    def cannot_track_email(self, course: Course, sheet_row) -> None:
        ...
        email = FJEmailSimple(to=self.admin_emails,
                              cc=self.code_admin_emails,
                              subject=title,
                              title=title,
                              text=email_text)
        email.send()    
        
    def weekly_report(self, course: Course, df:str) -> None:
        """Auto report """
        taker = course.taker
        title = "Weekly Report"
        word_course = "course" if len(course.links) == 1 else "courses"
    ...
    def offline_pretraining(self, course_trainer:str) -> None:
        """Auto report """
    ...
    def offline_posttraining(self, course_trainer:str) -> None:
        """Auto report """
        taker = course_trainer
        title = "Pre-training email"
        # word_course = "course" if len(course.links) == 1 else "courses"
        ...
        email_text = f"""Hi {taker.first_name()},<br><br>
                       Please fil the Post-training scores for the course <br><br>
                        FJ Offline Training
                        """
